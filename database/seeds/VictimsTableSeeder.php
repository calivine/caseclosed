...
class VictimsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($victims as $key => $victimData) {
            ...
            $victim->incident_date = $victimData[7];
            $victim->location = $victimData[8];
            $victim->description = $victimData[9];
            $victim->perpetrator_id = $victimData[10];
