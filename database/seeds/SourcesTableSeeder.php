...
class SourcesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $sources = [
            ...
            ['https://www.twincities.com/2010/02/18/family-of-former-st-paul-woman-killed-in-boston-in-1972-finally-has-some-answers/',null,null,null,null,1],
            ['https://abcnews.go.com/US/genetic-genealogy-leads-arrest-1973-cold-case-murder/story?id=59343378#',null,null,null,null,2],
            ['https://www.mercurynews.com/2018/06/28/sheriff-suspect-in-infamous-1974-stanford-chapel-murder-shoots-self-as-detectives-close-in/','https://www.mercurynews.com/2018/06/29/stanford-church-slaying-suspect-was-likely-plotting-suicide-for-two-years/',null,null,null,3]
        ];
        ...
        foreach($sources as $sourceData) {
            ...
            $source->perpetrator_id = $sourceData[5];
